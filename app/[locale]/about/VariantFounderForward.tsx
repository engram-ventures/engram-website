...
export default async function VariantFounderForward({ locale }: Props) {
  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-center">
            <div className="md:col-span-3 order-2 md:order-1">
              ...
              <h1 className="font-display text-5xl md:text-6xl font-light text-parchment leading-tight">
                {t("heading1")}
                <br />
                <em className="font-light text-ember">{t("heading2")}</em>
              </h1>
              <p className="font-body text-base font-light text-parchment/80 mt-8 max-w-md leading-relaxed">
                {t("founderCeo")} · {t("credential1")}
              </p>
            </div>
            <div className="md:col-span-2 order-1 md:order-2">
              <div className="relative">
                <div className="overflow-hidden rounded-xs border border-parchment/20">
                  <Image
                ...
                <div className="absolute -bottom-3 -right-3 w-full h-full border border-ember/30 rounded-xs -z-10" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Credentials strip — horizontal above the fold */}
      <section className="bg-parchment border-y border-parchment-dark py-10">
        <div className="max-w-6xl mx-auto px-6">
      ...
      {/* Story — narrative, no sidebar */}
      <section className="py-24 bg-parchment">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="font-display text-4xl font-light text-navy mb-10 leading-tight">
            {t("storyHeading")}
          </h2>
          <div className="space-y-6 font-body text-base font-light text-slate-dark leading-relaxed">
            <p>{t("storyP1")}</p>
            <p>{t("storyP2")}</p>
            <p>{t("storyP3")}</p>
            <p>{t("storyP4")}</p>
